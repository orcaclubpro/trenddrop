          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {displayProducts.map(product => (
              ...
              >
                ...
                <CardContent>
                  <div className="relative h-40 mb-4 bg-gray-100 rounded-md overflow-hidden flex items-center justify-center">
                    {product.imageUrl ? (
                      <img 
                      ...
                      <Pocket className="h-16 w-16 text-gray-300" />
                    )}
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    ...
                    {product.cjdropshippingUrl && (
                      <a 
                        ...
                        onClick={(e) => e.stopPropagation()}
                      >
                        CJDropshipping <ExternalLink className="h-3 w-3" />
                      </a>
                    )}
                    <span className="text-xs flex items-center gap-1 px-2 py-1 bg-gray-100 text-gray-700 rounded-full">
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-slate-50">
                  ...
                  <th className="p-2 text-left font-medium">Trend Score</th>
                      ...
                      <div className="flex items-center gap-2">
                        <div className="h-10 w-10 rounded-md bg-gray-100 flex items-center justify-center overflow-hidden">
                          {product.imageUrl ? (
                            ...
                            <Pocket className="h-5 w-5 text-gray-300" />
                          )}
                        </div>
